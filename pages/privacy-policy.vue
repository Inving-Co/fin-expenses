        ...
        <div class="row">
          <div class="col-md-12 dark:text-white">
            ...
            <p>At Inving.co, accessible from https://inving.co/, one of our main priorities is the privacy of
              ...
              recorded by Inving.co and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
              website with regards to the information that they shared and/or collect in Inving.co. This
            ...
            <h2>Log Files</h2>
            <p>Inving.co follows a standard procedure of using log files. These files log visitors when they
            ...
            <p>Like any other website, Inving.co uses "cookies". These cookies are used to store information
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
              that are used in their respective advertisements and links that appear on Inving.co, which are
            ...
            <p>Note that Inving.co has no access to or control over these cookies that are used by third-party
              advertisers.</p>
            <h2>Third Party Privacy Policies</h2>
            <p>Inving.co's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
            ...
            <p>Another part of our priority is adding protection for children while using the internet. We
              ...
              online activity.</p>
            <p>Inving.co does not knowingly collect any Personal Identifiable Information from children under
