      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 dark:text-white">
            <h1>Privacy Policy for kluarga.com</h1>
            <p>At kluarga.com, accessible from https://kluarga.com/, one of our main priorities is the privacy of
              our visitors. This Privacy Policy document contains types of information that is collected and
              recorded by kluarga.com and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
              website with regards to the information that they shared and/or collect in kluarga.com. This
            ...
            <h2>Log Files</h2>
            <p>kluarga.com follows a standard procedure of using log files. These files log visitors when they
            ...
            <p>Like any other website, kluarga.com uses "cookies". These cookies are used to store information
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
              that are used in their respective advertisements and links that appear on kluarga.com, which are
            ...
            <p>Note that kluarga.com has no access to or control over these cookies that are used by third-party
              advertisers.</p>
            <h2>Third Party Privacy Policies</h2>
            <p>kluarga.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
            ...
            <p>Another part of our priority is adding protection for children while using the internet. We
              ...
              online activity.</p>
            <p>kluarga.com does not knowingly collect any Personal Identifiable Information from children under
