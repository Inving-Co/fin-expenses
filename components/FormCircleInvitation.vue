<template>
  <div>
    <span class="font-semibold text-2xl text-transparent bg-clip-text bg-gradient-to-r to-emerald-500 from-lime-600">{{ circle?.name }}<small class="ml-2 font-light text-sm text-gray-500 dark:text-gray-400">Link Invitation</small></span>
