...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style11, h2.style11, h3.style11, p.style11', { style: 'fade-left', speed: 750, intensity: 5, delay: 0, replay: false });
		...
		onvisible.add('.icons.style3', { style: 'fade-up', speed: 1000, intensity: 3, delay: 250, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-left', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('.list.style1', { style: 'fade-up', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-left', speed: 750, intensity: 5, delay: 0, replay: false });
		onvisible.add('.buttons.style3', { style: 'fade-up', speed: 1000, intensity: 4, delay: 0, replay: false });
		onvisible.add('h1.style10, h2.style10, h3.style10, p.style10', { style: 'fade-left', speed: 1000, intensity: 10, delay: 0, replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-left', speed: 750, intensity: 5, delay: 0, replay: false });
		onvisible.add('.buttons.style2', { style: 'fade-up', speed: 1000, intensity: 4, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-up', speed: 1000, intensity: 3, delay: 250, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.image.style3', { style: 'fade-up', speed: 750, intensity: 4, delay: 0, replay: true });
		onvisible.add('#video01', { style: 'fade-up', speed: 1000, intensity: 5, delay: 0, replay: false });
