<template>
  ...
  <div v-if="!isRoot" class="pt-5 bg-white dark:bg-gray-800 px-16 border-b">
    <div class="flex items-center justify-between flex-wrap">
      ...
      <div class="flex align-center">
        <button @click="toggleDarkMode" id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 mr-4 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
      ...
      <general-dropdown id="dropdownActionMenuButton" class="w-full mt-4 sm:mt-0 md:w-[80px]">
        <template #trigger="{ activator }">
          <button
              class="h-[38px] w-full inline-flex items-center justify-between text-gray-500 bg-white drop-shadow hover:drop-shadow-md focus:drop-shadow-md focus:outline-none font-medium rounded-lg dark:ring-2 dark:ring-gray-700 text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700"
